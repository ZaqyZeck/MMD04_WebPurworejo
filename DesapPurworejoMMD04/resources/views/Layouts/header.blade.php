<header class="w-full bg-white border-b border-gray-200">
    <div class="max-w-[1400px] mx-auto flex justify-between items-center px-[70px] py-[35px]">
        ...
        <nav class="flex items-center gap-10">
            ...
            <a href="/government" class="text-[#444] text-lg font-medium pb-1 border-b-2 border-transparent hover:text-[#0D6B1E] hover:border-[#0D6B1E] transition-colors">Pemerintahan</a>
